...
def open_image():
    ...
    canvas.image = img_tk
root = Tk()
root.title("TUGAS Juan Sebastian Caesario Bawias F55121077")
root.configure(bg='grey')
menubar = Menu(root)
root.config(menu=menubar)
nama_label = Label(root, text="Juan Sebastian Caesario Bawias F55121077", font=("Helvetica", 10), pady=10, bg='grey')
nama_label.pack()
